...
class CreateCourseFormComponent(BaseComponent):
    def __init__(self, page: Page, text_area_index: int):
        super().__init__(page)
        ...
        self.description_textarea = page.get_by_test_id('create-course-form-description-input').locator('textarea').nth(text_area_index)
